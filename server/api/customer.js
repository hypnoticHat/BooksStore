...
router.post('/signup', async function (req, res) {
  ...
  if (dbCust) {
    ...
    const newCust = { username: username, password: password, name: name, phone: phone, email: email, active: 0, token: token , profile: profile};
...
router.put('/customers/:id', JwtUtil.checkToken, async function (req, res) {
  ...
  const email = req.body.email;
  const profile = req.body.profile;
  const customer = { _id: _id, username: username, password: password, name: name, phone: phone, email: email, profile:profile };
