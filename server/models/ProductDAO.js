...
const ProductDAO = {
  ...
  async update(product) {
    const newvalues = { name: product.name, price: product.price, image: product.image, author: product.author, publisher: product.publisher, describe: product.describe , category: product.category };
